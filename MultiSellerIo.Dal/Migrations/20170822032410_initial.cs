        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductId = table.Column<long>(type: "bigint", nullable: false),
                    ThumbName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Updated = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ProductVariantSpecificationAttributeMappings",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantSpecificationAttributeMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariantSpecificationAttributeMappings_ProductAttributeValues_ProductAttributeValueId",
                        column: x => x.ProductAttributeValueId,
                        principalTable: "ProductAttributeValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantSpecificationAttributeMappings_ProductVariants_ProductVariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantSpecificationAttributeMappings_ProductAttributeValueId",
                table: "ProductVariantSpecificationAttributeMappings",
                column: "ProductAttributeValueId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantSpecificationAttributeMappings_ProductVariantId",
                table: "ProductVariantSpecificationAttributeMappings",
